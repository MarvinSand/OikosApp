  ...
  return createPortal(
    <div style={{ position: 'fixed', inset: 0, zIndex: 9999 }}>
      ...
      <div style={{
        ...
        {/* 1) Sichtbarkeit – wer darf das Event sehen? */}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 12 }}>
          {VISIBILITY.map(v => {
            ...
            return (
              <button
                key={v.key}
                onClick={() => set('visibility_mode', v.key)}
                style={{
              ...
              >
                ...
                <div style={{
                  ...
                  border: `2px solid ${active ? C.accentDark : C.border}`,
        ...
        {/* Community-Auswahl bei "Gemeinde" */}
        {form.visibility_mode === 'communities' && (
          <div style={{ marginBottom: 18, padding: '12px 14px', background: C.bgSec, borderRadius: 12 }}>
            {myCommunities.length === 0 ? (
              ...
              <>
                <p style={{ fontSize: 12, color: C.textSec, margin: '0 0 8px' }}>
                  Eine oder mehrere Gemeinden auswählen:
                </p>
        ...
        {/* 2) Event-Art mit festem Symbol */}
        <label style={{ ...lbl, marginTop: 6 }}>Was für ein Event?</label>
        ...
        {/* 3) Freitext / Infos */}
        <label style={{ ...lbl, marginTop: 6 }}>Infos (optional)</label>
        <textarea
