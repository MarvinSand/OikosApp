...
-- Abschnitt. Das offizielle Bekenntnis unten ist der finale, vom Projekt
-- vorgegebene Wortlaut ("Mein tägliches Glaubensbekenntnis mit
-- Bibelstellen").
...
begin
  select id into official_creed_id from public.creeds where user_id is null and title = 'Mein tägliches Glaubensbekenntnis mit Bibelstellen';
